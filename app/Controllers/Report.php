...
class Report extends BaseController
{
    ...
    private function getTableData($data)
    {
        ...
        $html .= '<th style="background-color: #003366; color: #ffffff;">TEMPAT</th>';
        $html .= '<th style="background-color: #003366; color: #ffffff;">JENIS</th>';
