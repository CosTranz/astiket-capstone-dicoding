  ...
  <aside class="left-sidebar">
    ...
    <div>
      <div class="brand-logo d-flex align-items-center justify-content-between">
        ...
        <img src="<?= base_url() ?>/assets/images/logos/astiket.png" width="40px" alt="" />
          <span style="color: #012970; font-size: 1.8em;">ASTIKET</span>
        </a>
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="<?= site_url('Place') ?>" aria-expanded="false">
              <span>
